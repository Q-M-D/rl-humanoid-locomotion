...
DORA2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        #! Use the USD file converted from the URDF file for Dora2.
        #! The USD file converted from the MJCF file is not working properly.
...
@configclass
class McmBasedRlEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 1
    episode_length_s = 20.0
    # - spaces definition
    # See dora2_config.md for more details.
    action_space = Box(
        low=-5.0,
        high=5.0,
        shape=(12,),
    ...
    """Observation space dimension is 44*5 = 220.
    1: command velocity
